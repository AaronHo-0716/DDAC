...
async function main() {
  ...
  const userBlueprint = [
    { name: `Mock Homeowner A ${suffix}`, email: `mock-homeowner-a-${suffix}@fake-neighbourhelp.test`, role: "homeowner" },
    { name: `Mock Homeowner B ${suffix}`, email: `mock-homeowner-b-${suffix}@fake-neighbourhelp.test`, role: "homeowner" },
    { name: `Mock Handyman A ${suffix}`, email: `mock-handyman-a-${suffix}@fake-neighbourhelp.test`, role: "handyman" },
    { name: `Mock Handyman B ${suffix}`, email: `mock-handyman-b-${suffix}@fake-neighbourhelp.test`, role: "handyman" },
  ];
